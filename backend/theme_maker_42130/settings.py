"""
Django settings for theme_maker_42130 project.
...
ROOT_URLCONF = 'theme_maker_42130.urls'
...
WSGI_APPLICATION = 'theme_maker_42130.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "theme_maker_42130 API",
    "DESCRIPTION": "API documentation for theme_maker_42130 App",
    "VERSION": "v1",
}
